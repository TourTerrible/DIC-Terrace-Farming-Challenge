...
#define harvest_pin1        13  //Digital
#define harvest_pin2        12  //Digital
#define moisture_servo_pin  11  //PWM
#define seeding_pin1        9   //Digital
#define seeding_pin2        8   //Digital      
#define pump_pin_enable     6   //PWM
#define pump_pin1           5   //Digital
#define pump_pin2           4   //Digital
#define solenoid_pin        2   //Digital
...
void watering_func(bool flow_dir){
  if (water_job){
    ...
    //Turn on pump
    analogWrite(pump_pin_enable, HIGH);
